 ...
 */
async function signupUspSecondStep(req: any, res: any, next: any) {
  try {
    handleValidationResult(req);
 ...
 * Authenticate User
 */
async function authenticateUser(data: any, cb: any) {
 ...
 */
async function authenticationSuccess(req: any, res: any, next: any) {
  try {
 ...
 */
async function authenticationFailure(req: any, res: any, next: any) {
  return next(
